...
public class FillTypeRenderer extends JLabel implements TableCellRenderer {
	
	String imageBase = "../../../../";
	
  public FillTypeRenderer () {
  ...
  public Component getTableCellRendererComponent(
    ...
    setText ("");
		// If value "", that means no fill (shold never happen)
    if (((Integer)value).toString().equals(""))
      setIcon (null);
    else
			// Get image from the id
      setIcon (new ImageIcon (getClass().getResource(imageBase + "images/" + BaseElement.fillsImg[(Integer)value])));
